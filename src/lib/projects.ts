...
export const projects: project[] = [
  ...
  },
  {
    ...
    description: 'I wrote two plugins so far: ColorfulAnvil enabling MiniMessage in Anvils and Chat, and DiscordPlayerList to display online players on Discord. Check them out by clicking on the title!',
